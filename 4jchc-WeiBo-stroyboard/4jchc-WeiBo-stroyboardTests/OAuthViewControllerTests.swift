...
class OAuthViewControllerTests: XCTestCase {
    ...
    func testRandomCode() {
        for i in 0...20 {
            let democode = "f407af7ed603b9ed0fe85b89fef510b8\(i)"
    ...
    func testContiuneWithCode() {
         ...
         */
         ...
         // 登录界面的 URL
         // 应该加载，没有 code
        var url = NSURL(string: "https://api.weibo.com/oauth2/authorize?client_id=1620692692&redirect_uri=http://www.baidu.com")!
